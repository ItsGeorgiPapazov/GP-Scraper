...
class GPScraper:
    def __init__(self):
        ...
        self.color = Colors.StaticMIX((Colors.red, Colors.orange))
        ...
        if presets == "?":
            ...
            if presets in yes:
                ...
                print(Colorate.Diagonal(
                    Colors.DynamicMIX((Colors.yellow, Colors.StaticMIX((Colors.red, Colors.orange)))),
    ...
    def terminal(self, string: str = ""):
        if os.name == "nt":
            ctypes.windll.kernel32.SetConsoleTitleW("GP Scraper | github.com/ItsGeorgiPapazov " + string)
    ...
    def printLogo(self):
        logo = """
  ____ ____    ____
 / ___|  _ \  / ___|  ___ _ __ __ _ _ __   ___ _ __
| |  _| |_) | \___ \ / __| '__/ _` | '_ \ / _ \ '__|
| |_| |  __/   ___) | (__| | | (_| | |_) |  __/ |
 \____|_|     |____/ \___|_|  \__,_| .__/ \___|_|
                                   |_|
          by github.com/ItsGeorgiPapazov

    """
        os.system(self.clear)
        print(Colorate.Diagonal(Colors.DynamicMIX((Colors.yellow, Colors.StaticMIX((Colors.red, Colors.orange)))),
                                Center.XCenter(logo)))
